...
float mixValue = 0.2f; // stores the value of how much of the texture we see
...
int main()
{
    ...
    int width, height, nrChannels; // flip the texture to proper orientation
    ...
    {
        std::cout << "Fail to load texture: awesomeface.png" << stbi_failure_reason() << std::endl;
    }
    stbi_image_free(data);
